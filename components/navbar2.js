    ...
    >
      ...
      <div className="hidden sm:flex items-center justify-between px-6 md:px-16">
        ...
        <div className="flex space-x-4">
          <Link href="/login">
            <button className="bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-700 hover:to-sky-700  text-white font-bold py-1.5 px-4 rounded-full transition-transform hover:scale-105 duration-300 hover:shadow-md">
              Masuk
            </button>
          </Link>
      ...
      {/* Mobile Header */}
      <div className="sm:hidden relative flex h-8 items-center justify-between px-4"> 
      ...
      {isOpen && (
        <div className="sm:hidden bg-white/5 mt-3 backdrop-blur-lg border-t border-white/20">
          <div className="px-4 pt-2 pb-4 space-y-2 text-center">
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <Link href="/login">
                <button className="bg-amber-500 hover:bg-amber-600 text-white font-bold py-1.5 px-4 rounded-full text-sm transition-transform hover:scale-105">
                  Masuk
                </button>
              </Link>
              <Link href="/registrasi">
