...
export default function ForgotPasswordPage() {
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const msg = data.message || "Link reset password sudah dikirim ke email.";
			setSuccess(msg);
					...
					<div className="w-full md:w-1/2 p-8 md:p-10 relative bg-gradient-to-br from-white to-sky-50 flex flex-col justify-center">
						...
						<div className="absolute inset-0 flex items-center justify-center pointer-events-none">
							<Image
								...
								width={250}
								height={280}
								style={{ width: "250px", height: "280px", opacity: 0.1 }}
						...
						<div className="relative z-10">
							...
							{/* Tombol "Masuk Sekarang" saat sukses */}
							{success && (
								<SlideUp delay={700} className="mt-4 text-center">
									<Link
										href="/login"
										className="inline-block bg-gradient-to-r from-sky-500 to-blue-600 text-white px-6 py-2 rounded-full text-sm font-medium hover:from-sky-600 hover:to-blue-700 transition-all shadow-md">
										Masuk Sekarang
									</Link>
								</SlideUp>
							)}
							...
							{!success && (
								<SlideUp delay={700} className="text-center mt-8">
